AFRAME.registerComponent('create-cocacola-component', {
    schema: {},
    init : function() {
    ...
    createItem : function() {
        ...
        ItemNameElem.setAttribute('obj-model', {obj:'/assets/models/CocaCola.obj'});
        ItemNameElem.setAttribute('material', {src:'/assets/textures/can.png'});
